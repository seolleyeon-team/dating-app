...
test("account deletion plans scoped PII cleanup operations", () => {
  const docs = accountDeletionDocsFromParts({
    ...
    kakaoFriendPairIds: ["friend_u4_u1", "u1_zfriend_u9"],
  ...
  assert.deepEqual(operations, [
    ...
    // kakao-friend-pairs contract §9: pair docs of the deleted member go away.
    { kind: "deleteKakaoFriendPair", pairId: "friend_u4_u1" },
    { kind: "deleteKakaoFriendPair", pairId: "u1_zfriend_u9" },
