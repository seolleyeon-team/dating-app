/**
 * Apple Root CA certificates used by the App Store Server Library.
 *
 * The certificates are public trust anchors published by Apple. Keeping the
 * DER bytes in the deployed bundle avoids downloading trust material during a
 * purchase request.
 */
...
export const APPLE_ROOT_CERTIFICATES: readonly Buffer[] = [
