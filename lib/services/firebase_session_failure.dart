...
class FirebaseSessionFailure implements Exception {
  ...
  String get userMessage {
    ...
    if (reason != FirebaseSessionFailureReason.appCheckUnavailable &&
        reason != FirebaseSessionFailureReason.appCheckRejected) {
      return message;
    }

    final safeCode = _safeSupportCode(supportCode);
    return safeCode == null ? message : '$message\n진단 코드: $safeCode';
  }

  static String? _safeSupportCode(String? value) {
