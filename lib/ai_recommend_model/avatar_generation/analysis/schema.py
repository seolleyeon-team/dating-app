...
class SourceAnalysisResult:
    ...
    face_count: int = 0
    faces: Sequence[FaceDetection] = field(default_factory=tuple, repr=False)
    primary_face: Optional[FaceDetection] = field(default=None, repr=False)
    primary_face_bbox: Optional[BBox] = field(default=None, repr=False)
    ...
    # Worker-memory only. Never include in to_document()/logs.
    analysis_reference_image: Any = field(default=None, repr=False, compare=False)
    internal_face_analysis: Any = field(default=None, repr=False, compare=False)
    ...
    def to_document(self) -> Dict[str, object]:
        ...
        document: Dict[str, object] = {
            ...
            "usedTileFallback": bool(self.used_tile_fallback),
            "faceSizeBucket": self.face_size_bucket,
        }
        return document
