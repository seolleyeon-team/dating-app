...
| 04-security-findings / 05-correctness / 06-performance / 07-fallback | `04-p0-authz-hardening-findings.md` |
| 08-remediation-plan / 09-change-log | `04-p0-authz-hardening-findings.md` 의 상태 열 + git log |
...
- 채팅·무물·커뮤니티 남용 (스팸, XSS, senderId 위조, 차단 후 전송)
  — 규칙 수준 노출은 확인했으나 수정하지 않았다. `04-p0-authz-hardening-findings.md` 참조.
