...
void main() {
  test('recommendation service must not scan users collection as fallback', () {
    final source = File('lib/services/ai_recommendation_service.dart')
        .readAsStringSync();
  ...
  test('AI preference screen must not use placeholder or random gender pool', () {
    final source = File(
  ...
  test('terms screen and chat list gate fake_user entry behind DevEntryPolicy', () {
    final terms = File(
