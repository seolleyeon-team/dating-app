...
class InternalFaceDetection:
    ...
    border_clearance: float = 0.0
    sharpness_score: Optional[float] = None


@dataclass(frozen=True)
class PrimaryFaceSelection:
    primary: Optional[InternalFaceDetection]
    secondary_faces: Tuple[InternalFaceDetection, ...]
    primary_score: float
...
class InternalFaceAnalysis:
    ...
    secondary_detections: Tuple[InternalFaceDetection, ...]
    crop_transform: Optional[CropTransform]
