...
rg -n "export const getChatRealProfilePhoto|createGetChatRealProfilePhotoFunction|export const beginAvatarGenerationFromOnboardingPhotos" functions/src/index.ts functions/src/chatRealPhoto.ts functions/src/avatarMedia.ts
...
with open(sys.argv[1], "r", encoding="utf-8") as f:
    data = json.load(f)
selected = {"getChatRealProfilePhoto", "beginAvatarGenerationFromOnboardingPhotos"}
rows = []
