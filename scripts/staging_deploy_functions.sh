...
APPLY=false
FUNCTION_TARGETS="${FUNCTION_TARGETS:-functions:getChatRealProfilePhoto,functions:uploadOnboardingPhoto,functions:beginAvatarGenerationFromOnboardingPhotos,functions:getAvatarJobCandidates,functions:approveAvatarCandidate}"
